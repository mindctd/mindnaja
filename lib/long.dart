import 'package:eyetestapp/longquestion.dart';
import 'package:eyetestapp/score2.dart';
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child:
          ...
          const Text(
            "กรุณาถอดแว่นตาและยืดสุดแขนก่อนทำข้อที่ 6",
            style: TextStyle(
              color: Colors.red,
              fontSize: 24,
            ),
    ...
    return AlertDialog(
      ...
      content: ElevatedButton(
        ...
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const score2()),
          );
        },
      ),
    );
